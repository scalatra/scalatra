...
object Dependencies {
  ...
  lazy val scalatestJunit           =  "org.scalatestplus"       %% "junit-4-13"                 % "3.2.12.0"
  ...
  lazy val metricsServlets          =  "io.dropwizard.metrics"   %  "metrics-servlets"           % "4.2.10"
  lazy val metricsServlet           =  "io.dropwizard.metrics"   %  "metrics-servlet"            % "4.2.10"
  ...
  private val jettyVersion            = "9.4.47.v20220610"
  private val json4sVersion           = "4.0.5"
  private val specs2Version           = "4.16.0"
