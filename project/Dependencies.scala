...
object Dependencies {
  ...
  lazy val httpclient               =  "org.apache.httpcomponents.client5" % "httpclient5"       % "5.2.2"
  ...
  lazy val logbackClassic           =  "ch.qos.logback"          %  "logback-classic"            % "1.4.12"
  lazy val mockitoAll               =  "org.mockito"             %  "mockito-core"               % "5.7.0"
  ...
  lazy val metricsServletsJavax     =  "io.dropwizard.metrics"   %  "metrics-servlets"           % "4.2.22"
  lazy val metricsServletJavax      =  "io.dropwizard.metrics"   %  "metrics-servlet"            % "4.2.22"
  lazy val metricsServletsJakarta   =  "io.dropwizard.metrics"   %  "metrics-jakarta-servlets"   % "4.2.22"
  lazy val metricsServletJakarta    =  "io.dropwizard.metrics"   %  "metrics-jakarta-servlet"    % "4.2.22"
