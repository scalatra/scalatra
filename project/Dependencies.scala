...
object Dependencies {
  ...
  lazy val httpclient          = "org.apache.httpcomponents.client5" % "httpclient5"              % "5.4.1"
  ...
  lazy val jettyWebappJakarta  = "org.eclipse.jetty.ee10"            % "jetty-ee10-webapp"        % "12.0.16"
  ...
  lazy val mockitoAll          = "org.mockito"                       % "mockito-core"             % "5.15.2"
  ...
  lazy val metricsServletsJavax   = "io.dropwizard.metrics"    % "metrics-servlets"         % "4.2.29"
  lazy val metricsServletJavax    = "io.dropwizard.metrics"    % "metrics-servlet"          % "4.2.29"
  lazy val metricsServletsJakarta = "io.dropwizard.metrics"    % "metrics-jakarta-servlets" % "4.2.29"
  lazy val metricsServletJakarta  = "io.dropwizard.metrics"    % "metrics-jakarta-servlet"  % "4.2.29"
  lazy val googleGuava            = "com.google.guava"         % "guava"                    % "33.4.0-jre"
