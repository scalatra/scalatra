...
object Dependencies {
  lazy val parserCombinators        =  "org.scala-lang.modules"  %% "scala-parser-combinators"   % "2.0.0"
  ...
  lazy val mockitoAll               =  "org.mockito"             %  "mockito-core"               % "3.11.2"
  ...
  lazy val metricsServlets          =  "io.dropwizard.metrics"   %  "metrics-servlets"           % "4.2.2"
  lazy val metricsServlet           =  "io.dropwizard.metrics"   %  "metrics-servlet"            % "4.2.2"
  ...
  private val specs2Version           = "4.12.2"
