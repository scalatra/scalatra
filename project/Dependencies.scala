...
object Dependencies {
  ...
  lazy val collectionCompact        =  "org.scala-lang.modules"  %% "scala-collection-compat"    % "2.12.0"
  lazy val commonsText              =  "org.apache.commons"      %  "commons-text"               % "1.12.0"
  lazy val httpclient               =  "org.apache.httpcomponents.client5" % "httpclient5"       % "5.4"
  ...
  lazy val jettyWebappJakarta       =  "org.eclipse.jetty.ee10"  %  "jetty-ee10-webapp"          % "12.0.14"
  ...
  lazy val mockitoAll               =  "org.mockito"             %  "mockito-core"               % "5.14.1"
  ...
  lazy val slf4jApi                 =  "org.slf4j"               %  "slf4j-api"                  % "2.0.16"
  lazy val specs2                   =  Seq(
                                       "org.specs2"              %% "specs2-core",
                                       "org.specs2"              %% "specs2-matcher-extra"
                                       ).map(_ % specs2Version)
  lazy val metricsScala             =  "nl.grons"                %% "metrics4-scala"             % "4.3.3"
  lazy val metricsServletsJavax     =  "io.dropwizard.metrics"   %  "metrics-servlets"           % "4.2.28"
  lazy val metricsServletJavax      =  "io.dropwizard.metrics"   %  "metrics-servlet"            % "4.2.28"
  lazy val metricsServletsJakarta   =  "io.dropwizard.metrics"   %  "metrics-jakarta-servlets"   % "4.2.28"
  lazy val metricsServletJakarta    =  "io.dropwizard.metrics"   %  "metrics-jakarta-servlet"    % "4.2.28"
  lazy val googleGuava              =  "com.google.guava"        %  "guava"                      % "33.3.1-jre"
  lazy val twirlApi                 =  "org.playframework.twirl"       %% "twirl-api"                  % "2.0.7"

  private val json4sVersion           = "4.0.7"
  private val specs2Version           = "4.20.8"
