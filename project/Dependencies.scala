...
object Dependencies {
  ...
  lazy val jettyWebappJavax         =  "org.eclipse.jetty"       %  "jetty-webapp"               % "10.0.21"
  lazy val jettyServletJakarta      =  "org.eclipse.jetty.ee10"  %  "jetty-ee10-servlet"         % "12.0.9"
  lazy val jettyWebappJakarta       =  "org.eclipse.jetty.ee10"  %  "jetty-ee10-webapp"          % "12.0.10"
  ...
  lazy val slf4jApi                 =  "org.slf4j"               %  "slf4j-api"                  % "2.0.13"
  lazy val specs2                   =  Seq(
  ...
  lazy val googleGuava              =  "com.google.guava"        %  "guava"                      % "33.2.1-jre"
  lazy val twirlApi                 =  "org.playframework.twirl"       %% "twirl-api"                  % "2.0.5"
