...
object Dependencies {
  ...
  lazy val httpclient          = "org.apache.httpcomponents.client5" % "httpclient5"              % "5.6.1"
  ...
  lazy val jettyWebappJakarta  = "org.eclipse.jetty.ee11"            % "jetty-ee11-webapp"        % "12.1.9"
  ...
  lazy val metricsServletsJavax   = "io.dropwizard.metrics"    % "metrics-servlets"         % "4.2.38"
  lazy val metricsServletJavax    = "io.dropwizard.metrics"    % "metrics-servlet"          % "4.2.38"
  lazy val metricsServletsJakarta = "io.dropwizard.metrics"    % "metrics-jakarta-servlets" % "4.2.38"
  lazy val metricsServletJakarta  = "io.dropwizard.metrics"    % "metrics-jakarta-servlet"  % "4.2.38"
