...
object Dependencies {
  ...
  lazy val mockitoAll               =  "org.mockito"             %  "mockito-core"               % "4.3.1"
  ...
  lazy val metricsServlets          =  "io.dropwizard.metrics"   %  "metrics-servlets"           % "4.2.8"
  lazy val metricsServlet           =  "io.dropwizard.metrics"   %  "metrics-servlet"            % "4.2.8"
  ...
  private val specs2Version           = "4.14.1"
