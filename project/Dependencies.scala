...
object Dependencies {
  ...
  lazy val jettyServletJakarta =
    "org.eclipse.jetty.ee10" % "jetty-ee10-servlet" % "12.0.9"
  lazy val jettyWebappJakarta =
  ...
  lazy val metricsServletsJavax =
    "io.dropwizard.metrics" % "metrics-servlets" % "4.2.29"
  lazy val metricsServletJavax =
    "io.dropwizard.metrics" % "metrics-servlet" % "4.2.29"
  lazy val metricsServletsJakarta =
    "io.dropwizard.metrics" % "metrics-jakarta-servlets" % "4.2.29"
  lazy val metricsServletJakarta =
    "io.dropwizard.metrics" % "metrics-jakarta-servlet" % "4.2.29"
