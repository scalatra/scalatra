...
object Dependencies {
  lazy val parserCombinators   = "org.scala-lang.modules"           %% "scala-parser-combinators" % "2.5.0"
  ...
  lazy val jettyWebappJakarta  = "org.eclipse.jetty.ee11"            % "jetty-ee11-webapp"        % "12.1.13"
  ...
  lazy val servletApiJakarta = "jakarta.servlet" % "jakarta.servlet-api" % "6.1.0"
  lazy val slf4jApi          = "org.slf4j"       % "slf4j-api"           % "2.0.19"
  lazy val specs2            = Seq(
    "org.specs2" %% "specs2-core",
    "org.specs2" %% "specs2-matcher-extra"
  ).map(_ % specs2Version)
  lazy val metricsScala           = "nl.grons"                %% "metrics4-scala"           % "4.3.7"
  lazy val metricsServletsJavax   = "io.dropwizard.metrics"    % "metrics-servlets"         % "4.2.40"
  lazy val metricsServletJavax    = "io.dropwizard.metrics"    % "metrics-servlet"          % "4.2.40"
  lazy val metricsServletsJakarta = "io.dropwizard.metrics"    % "metrics-jakarta-servlets" % "4.2.40"
  lazy val metricsServletJakarta  = "io.dropwizard.metrics"    % "metrics-jakarta-servlet"  % "4.2.40"
  lazy val googleGuava            = "com.google.guava"         % "guava"                    % "33.7.1-jre"
