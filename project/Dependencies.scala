...
object Dependencies {
  lazy val parserCombinators =
    "org.scala-lang.modules" %% "scala-parser-combinators" % "2.1.0" cross CrossVersion.for3Use2_13
  ...
  lazy val atmosphereJQuery =
    "org.atmosphere.client" % "jquery" % "2.2.21" artifacts (Artifact(
      "jquery",
      "war",
      "war"
    ))
  lazy val atmosphereClient = "org.atmosphere" % "wasync" % "2.1.7"
  lazy val atmosphereRedis = "org.atmosphere" % "atmosphere-redis" % "2.6.5"
  ...
  lazy val metricsScala =
    "nl.grons" %% "metrics4-scala" % "4.1.19" cross CrossVersion.for3Use2_13
  lazy val metricsServlets =
    "io.dropwizard.metrics" % "metrics-servlets" % "4.2.4"
  lazy val metricsServlet =
    "io.dropwizard.metrics" % "metrics-servlet" % "4.2.4"
  lazy val googleGuava = "com.google.guava" % "guava" % "31.0.1-jre"
  lazy val twirlApi =
    "com.typesafe.play" %% "twirl-api" % "1.5.1" cross CrossVersion.for3Use2_13
