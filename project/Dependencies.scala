...
object Dependencies {
  ...
  lazy val metricsServlets          =  "io.dropwizard.metrics"   %  "metrics-jakarta-servlets"   % "4.2.12"
  lazy val metricsServlet           =  "io.dropwizard.metrics"   %  "metrics-jakarta-servlet"    % "4.2.12"
  ...
  private val jettyVersion            = "11.0.12"
