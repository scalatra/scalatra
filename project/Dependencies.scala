...
object Dependencies {
  ...
  lazy val mockitoAll               =  "org.mockito"             %  "mockito-core"               % "5.2.0"
  ...
  lazy val metricsServlets          =  "io.dropwizard.metrics"   %  "metrics-servlets"           % "4.2.17"
  lazy val metricsServlet           =  "io.dropwizard.metrics"   %  "metrics-servlet"            % "4.2.17"
