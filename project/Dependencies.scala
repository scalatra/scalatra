...
object Dependencies {
  ...
  lazy val atmosphereRuntime        =  "org.atmosphere"          %  "atmosphere-runtime"         % "2.5.4"
  ...
  lazy val atmosphereRedis          =  "org.atmosphere"          %  "atmosphere-redis"           % "2.5.0"
  ...
  lazy val mockitoAll               =  "org.mockito"             %  "mockito-core"               % "3.0.0"
