...
object Dependencies {
  ...
  lazy val jettyWebappJakarta  = "org.eclipse.jetty.ee11"            % "jetty-ee11-webapp"        % "12.1.10"
  ...
  lazy val logbackClassic      = "ch.qos.logback"                    % "logback-classic"          % "1.5.36"
  ...
  lazy val metricsServletsJavax   = "io.dropwizard.metrics"    % "metrics-servlets"         % "4.2.39"
