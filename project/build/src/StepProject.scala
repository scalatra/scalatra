...
class StepProject(info: ProjectInfo) extends ParentProject(info)
{
  ...
  class CoreProject(info: ProjectInfo) extends DefaultProject(info) {
    ...
    override def pomExtra = parentPom ++ (
      <name>step</name>
      <description>The core Step library</description>
    )
  ...
  class FileuploadProject(info: ProjectInfo) extends DefaultProject(info) {
    ...
    override def pomExtra = parentPom ++ (
      <name>step-fileupload</name>
      <description>Supplies the optional Step file upload support</description>
    )
    override def pomIncludeRepository(repo: MavenRepository) = false
  }
  ...
  class ScalateProject(info: ProjectInfo) extends DefaultProject(info) {
    ...
    override def pomExtra = parentPom ++ (
      <name>step-scalate</name>
      <description>Supplies the optional Step Scalate support</description>
    )
    override def pomIncludeRepository(repo: MavenRepository) = false
  }
  ...
  class ExampleProject(info: ProjectInfo) extends DefaultWebProject(info) {
    ...
    override def pomExtra = parentPom ++ (
      <name>step-example</name>
      <description>An example Step application</description>
    )
    override def pomIncludeRepository(repo: MavenRepository) = false
  }
  ...
  override def pomExtra = (
    ...
    <mailingLists>
      <mailingList>
        <name>Step user group</name>
        <archive>http://groups.google.com/group/step-user</archive>
        <post>step-user@googlegroups.com</post>
        <subscribe>step-user+subscribe@googlegroups.com</subscribe>
        <unsubscribe>step-user+unsubscribe@googlegroups.com</unsubscribe>
      </mailingList>
    </mailingLists>
    ...
    <distributionManagement>
      ...
      <!-- 
        <site>
          <id>step.github.org</id>
          <url>dav:http://step.github.org/</url>
        </site> 
      -->
    </distributionManagement>  
  ...
  val parentPom = 
    <parent>
      <groupId>com.thinkminimo.step</groupId>
