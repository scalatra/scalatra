...
trait ScalateRenderSupport { self: ScalatraSyntax with ScalateSupport =>
  ...
  def render(file: String, params: Map[String, Any] = Map(), responseContentType: String = "text/html", cacheMaxAge: Int = none, statusCode: Int = 200)(implicit ctx: ActionContext) {
