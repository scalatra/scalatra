...
class CookieTest extends WordSpec with MustMatchers {
  ...
  "a Cookie" should {
    ...
    "render a name with multiple values" in {
      ...
      cookie.toCookieString must equal("theName=value1&value2&value3")
    }
    ...
    "render a cookie with all options set" in {
      ...
      cookie.toCookieString must
       equal("cookiename=value1&value2&value3; Domain=.nowhere.com; Path=/path/to/page; Comment=the cookie thingy comment; " +
