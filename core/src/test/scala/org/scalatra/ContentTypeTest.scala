...
//// Generated Code
////    ContentTypeTestServlet.this.addRoute(Get,
////        Seq(ContentTypeTestServlet.this.string2RouteMatcher("/implicit/byte-array")),
////      (request: HttpServletRequest, response: HttpServletResponse) => scala.Array.apply[scala.Byte]()(ClassTag.Byte))
//
//    // ClassTag doesn't get resolved
//    //Array[Byte]()
//
//    sys.error("Macro fails...")
//  }
//
