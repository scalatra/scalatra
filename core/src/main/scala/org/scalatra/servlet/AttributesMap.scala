...
trait AttributesMap {
  ...
  /** Optionally returns the attribute associated with the key
    ...
    *   The key to find
    * @return
    *   an option value containing the attribute associated with the key in the
    *   underlying servlet object, or None if none exists.
    */
  ...
  /** Returns the attribute associated with the key or default value
    ...
    * @return
    *   an value for the attributed associated with the key in the underlying
    *   servlet object, or the default value if the key doesn't exist
    */
  def getOrElse(key: String, default: => Any): Any = get(key) getOrElse default

  /** Returns the attribute associated with the key or update attributes with
    * the specified value
    *
    * @param key
    *   The key to find
    * @param value
    *   The value that will be updated the attribute associated with the key
    *   when the key does not exist
    * @return
    *   an value for the attributed associated with the key in the underlying
    *   servlet object, or the updated value if the key doesn't exist
    */
  ...
  /** Returns the attribute associated with the key or throw an exception when
    * nothing found
    *
    * @param key
    *   The key to find
    * @return
    *   an value for the attributed associated with the key in the underlying
    *   servlet object, or throw an exception if the key doesn't exist
    */
  ...
  /** Optionally returns and type cast the attribute associated with the key
    ...
    * @return
    *   an option value containing the attributed associated with the key in the
    *   underlying servlet object, or None if none exists
    */
  def getAs[T](key: String)(implicit
      converter: TypeConverter[Any, T]
  ): Option[T] =
  ...
  /** Creates a new iterator over all attributes in the underlying servlet
    * object.
    *
    * @return
    *   the new iterator
  ...
  /** dumps all keys and values
    */
  def dumpAll: String = keys.map { a =>
    s"${a}=${attributes.getAttribute(a)}"
  } mkString "&"
}
