...
trait AttributesMap {
  ...
  /** Optionally returns the attribute associated with the key
    ...
    *   The key to find
    * @return
    *   an option value containing the attribute associated with the key in the underlying servlet object, or None if
    *   none exists.
    */
  ...
  /** Returns the attribute associated with the key or default value
    ...
    * @return
    *   an value for the attributed associated with the key in the underlying servlet object, or the default value if
  ...
  /** Returns the attribute associated with the key or update attributes with the specified value
    ...
    * @return
    *   an value for the attributed associated with the key in the underlying servlet object, or the updated value if
    *   the key doesn't exist
    */
  ...
  /** Returns the attribute associated with the key or throw an exception when nothing found
    ...
    *   The key to find
    * @return
    *   an value for the attributed associated with the key in the underlying servlet object, or throw an exception if
    *   the key doesn't exist
    */
  ...
  /** Optionally returns and type cast the attribute associated with the key
    ...
    * @return
    *   an option value containing the attributed associated with the key in the underlying servlet object, or None if
    *   none exists
    */
