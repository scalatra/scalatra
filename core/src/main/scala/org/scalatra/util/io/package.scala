...
package object io {
  ...
  /** Executes a block with a closeable resource, and closes it after the block
    * runs
    *
    * @tparam A
  ...
  /** Copies the input stream to the output stream.
    *
    * @param in
    *   the input stream to read. The InputStream will be closed, unlike
  ...
  /** Creates a temp file, passes it to a block, and removes the temp file on
    * the block's completion.
    *
    * @tparam A
    *   the return type of the block
    * @param content
    ...
    * @param directory
    *   The directory of the temp file; a system dependent temp directory if
    *   None
    * @param f
    *   the block
    * @return
