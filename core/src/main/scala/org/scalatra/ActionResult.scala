...
object NoContent {
  def apply(headers: Map[String, String] = Map.empty) =
    ActionResult(204, Unit, headers)
}

object ResetContent {
  def apply(headers: Map[String, String] = Map.empty) =
    ActionResult(205, Unit, headers)
}
...
object UseProxy {
  def apply(location: String, headers: Map[String, String] = Map.empty) =
    ActionResult(305, Unit, Map("Location" -> location) ++ headers)
}
...
object PermanentRedirect {
  def apply(location: String, headers: Map[String, String] = Map.empty) =
    ActionResult(308, Unit, Map("Location" -> location) ++ headers)
}
