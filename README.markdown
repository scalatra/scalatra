...
The latest version of Scalatra is `3.2.+`, and is published to [Maven Central](https://repo1.maven.org/maven2/org/scalatra).
...
// for jakarta
libraryDependencies += "org.scalatra" %% "scalatra-jakarta" % "3.2.+"
```
