## Scalatra [![Build Status](https://travis-ci.org/scalatra/scalatra.svg?branch=2.3.x)](https://travis-ci.org/scalatra/scalatra)
...
The 2.3.x branch is published as `2.3.2-SNAPSHOT` to [OSSRH](http://oss.sonatype.org/content/repositories/snapshots/org/scalatra). 

```scala
resolvers += "Sonatype Nexus Snapshots" at "https://oss.sonatype.org/content/repositories/snapshots"

libraryDependencies += "org.scalatra" %% "scalatra" % "2.3.2-SNAPSHOT"
```
