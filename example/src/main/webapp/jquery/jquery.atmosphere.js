    ...
    AtmosphereRequest: function(options) {
      ...
      function _local(request) {
        ...
        function listener(string) {
          var command = jQuery.parseJSON(string),
            data = command.data;
          ...
          servers = {
            ...
            windowref: function() {
              ...
              var neim = name.replace(/\W/g, ""),
                win = (jQuery('iframe[name="' + neim + '"]')[0] || jQuery('<iframe name="' + neim + '" />').hide().appendTo("body")[0]).contentWindow;
