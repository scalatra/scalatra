...
package object forms {
  ...
  private[forms] def getSingleParam(
  ...
  def text(constraints: Constraint*): SingleValueType[String] =
    new SingleValueType[String](constraints*) {
      def convert(value: String, messages: Messages): String = value
    }

  /** ValueType for the Boolean property.
    */
  def boolean(constraints: Constraint*): SingleValueType[Boolean] =
    new SingleValueType[Boolean](constraints*) {
  ...
  /** ValueType for the Int property.
    */
  def number(constraints: Constraint*): SingleValueType[Int] =
    new SingleValueType[Int](constraints*) {
          ...
          case Nil =>
            try {
              ...
              case e: NumberFormatException =>
                Seq(name -> messages("error.number").format(name))
            }
          case errors => errors
        }
    }
  ...
  /** ValueType for the Double property.
    */
  def double(constraints: Constraint*): SingleValueType[Double] =
    new SingleValueType[Double](constraints*) {
        ...
        super.validate(name, value, params, messages) match {
          case Nil =>
            try {
              ...
              case e: NumberFormatException =>
                Seq(name -> messages("error.double").format(name))
            }
          case errors => errors
        }
    }
  ...
  /** ValueType for the Long property.
    */
  def long(constraints: Constraint*): SingleValueType[Long] =
    new SingleValueType[Long](constraints*) {
        ...
        super.validate(name, value, params, messages) match {
          case Nil =>
            try {
              ...
              case e: NumberFormatException =>
                Seq(name -> messages("error.long").format(name))
            }
          case errors => errors
        }
    }
  ...
  ): SingleValueType[java.util.Date] =
    new SingleValueType[java.util.Date](
      ((datePattern(pattern) +: constraints))*
    ) {
  ...
  )(factory: (P1) => T): MappingValueType[T] = new MappingValueType[T] {
  ...
  )(factory: (P1, P2, P3, P4) => T): MappingValueType[T] =
  ...
  )(factory: (P1, P2, P3, P4, P5) => T): MappingValueType[T] =
    new MappingValueType[T] {
  ...
  )(factory: (P1, P2, P3, P4, P5, P6) => T): MappingValueType[T] =
    new MappingValueType[T] {
  ...
  )(factory: (P1, P2, P3, P4, P5, P6, P7) => T): MappingValueType[T] =
    new MappingValueType[T] {
  ...
  )(factory: (P1, P2, P3, P4, P5, P6, P7, P8) => T): MappingValueType[T] =
    new MappingValueType[T] {
      def fields: Seq[(String, ValueType[?])] =
        Seq(f1, f2, f3, f4, f5, f6, f7, f8)
      def convert(
          name: String,
          params: Map[String, Seq[String]],
          messages: Messages
  ...
  )(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9) => T): MappingValueType[T] =
    new MappingValueType[T] {
      def fields: Seq[(String, ValueType[?])] =
        Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9)
      def convert(
          name: String,
          params: Map[String, Seq[String]],
          messages: Messages
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10](
      ...
      factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) => T
  ): MappingValueType[T] = new MappingValueType[T] {
    def fields: Seq[(String, ValueType[?])] =
      Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10)
    def convert(
        name: String,
        params: Map[String, Seq[String]],
        messages: Messages
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11](
      ...
      factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) => T
  ): MappingValueType[T] = new MappingValueType[T] {
    def fields: Seq[(String, ValueType[?])] =
      Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11)
    def convert(
        name: String,
        params: Map[String, Seq[String]],
        messages: Messages
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12](
      ...
      factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) => T
  ): MappingValueType[T] = new MappingValueType[T] {
    def fields: Seq[(String, ValueType[?])] =
      Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12)
    def convert(
        name: String,
        params: Map[String, Seq[String]],
        messages: Messages
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13](
      ...
      factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13) => T
  ): MappingValueType[T] =
    new MappingValueType[T] {
      def fields: Seq[(String, ValueType[?])] =
        Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13)
      def convert(
          name: String,
          params: Map[String, Seq[String]],
          messages: Messages
  ...
  )(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14) => T)
      : MappingValueType[T] =
    new MappingValueType[T] {
      def fields: Seq[(String, ValueType[?])] =
        Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14)
      def convert(
          name: String,
          params: Map[String, Seq[String]],
          messages: Messages
  ...
  def mapping[
    ...
    new MappingValueType[T] {
      def fields: Seq[(String, ValueType[?])] =
        Seq(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15)
      def convert(
          name: String,
          params: Map[String, Seq[String]],
          messages: Messages
  ...
  private def p[T](
    ...
    field match {
      case (fieldName, valueType) =>
        valueType.convert(
          if (name.isEmpty) fieldName else name + "." + fieldName,
          params,
          messages
        )
    }
  ...
  /** ValueType for the List property. Parameter name must be "name[index]" or
    * "name[index][subName]".
    */
  def list[T](valueType: ValueType[T]): ValueType[List[T]] =
    new ValueType[List[T]]() {

      private def extractSingleParams(
          name: String,
          params: Map[String, Seq[String]]
      ): List[(Int, String)] =
        params.toList
          .flatMap { case (key, values) =>
            key match {
              case x @ IndexedSingleParamPattern(_, i)
                  if (x.startsWith(name + "[")) =>
                Seq((i.toInt, getSingleParam(params, key).get))
              case x if x == name =>
                values.zipWithIndex.map { case (x, i) => (i, x) }
              case _ => Nil
            }
          }
          .sortBy(_._1)

      private def extractMapParams(
          params: Map[String, Seq[String]]
      ): Map[Int, Map[String, Seq[String]]] =
        params
          .flatMap {
            case (key, value :: _) =>
              key match {
                case IndexedMapParamPattern(_, i, s) =>
                  Some((i.toInt, s.replaceAll("\\]\\[", "."), value))
                case _ => None
              }
            case _ => None
          }
        ...
        valueType match {
          ...
          case mappingValueType =>
            ...
            (for (i <- 0 to max) yield {
              val rowParams =
                listParams.getOrElse(i, Map.empty[String, Seq[String]])
  ...
  def optional[T](valueType: SingleValueType[T]): SingleValueType[Option[T]] =
    new SingleValueType[Option[T]]() {
      ...
      override def validate(
        ...
        else valueType.validate(name, value, params, messages)
    }
  ...
  def optional[T](
    ...
    override def convert(
      ...
      if (condition(params)) Some(valueType.convert(name, params, messages))
      else None
  ...
  /** ValueType wrapper for the optional property which is available if checkbox
    * is checked.
    */
  def optionalIfNotChecked[T](
      checkboxName: String,
      valueType: MappingValueType[T]
  ): ValueType[Option[T]] =
    optional(params => boolean().convert(checkboxName, params, null), valueType)

  /** ValueType wrapper for the optional property which is required if condition
    * is true.
    */
  ...
  /** ValueType wrapper for the optional property which is required if checkbox
    * is checked.
    */
  def optionalRequiredIfChecked[T](
      checkboxName: String,
      valueType: SingleValueType[T]
  ): SingleValueType[Option[T]] =
    optionalRequired(
      params =>
  ...
  def trim[T](valueType: SingleValueType[T]): SingleValueType[T] =
    new SingleValueType[T]() {
      ...
      def convert(value: String, messages: Messages): T =
        valueType.convert(trim(value), messages)
  ...
  /** ValueType wrapper to specified a property name which is used in the error
    * message.
    *
    * {{{
  ...
  def label[T](
      label: String,
      valueType: SingleValueType[T]
  ): SingleValueType[T] = new SingleValueType[T]() {
    ...
    override def validate(
      ...
      valueType.validate(label, value, params, messages).map {
        case (label, message) =>
          name -> message
      }
  ...
  def required: Constraint = new Constraint() {
    override def validate(
      ...
      if (value == null || value.isEmpty)
        Some(messages("error.required").format(name))
      else None
  }
    ...
    new Constraint {
      override def validate(
        ...
        if (value != null && !value.matches("^" + pattern + "$")) {
          Some(
            (if (message.isEmpty) messages("error.pattern") else message)
              .format(name, pattern)
          )
        } else None
    }

  def datePattern(pattern: String, message: String = ""): Constraint =
    new Constraint {
      override def validate(
          name: String,
          value: String,
        ...
        if (value != null && value.nonEmpty) {
          try {
            ...
            case _: java.text.ParseException =>
              Some(
                (if (message.isEmpty) messages("error.datePattern")
                 else message).format(name, pattern)
              )
          }
        } else None
    }
